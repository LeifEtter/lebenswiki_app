...
class AboutUsViewNew extends StatefulWidget {
  const AboutUsViewNew({Key? key}) : super(key: key);

  @override
  State<AboutUsViewNew> createState() => _AboutUsViewNewState();
}

class _AboutUsViewNewState extends State<AboutUsViewNew> {
