...
import 'package:lebenswiki_app/components/action_menu/modal_sheet.dart';
...
import 'package:lebenswiki_app/helper/isLoading.dart';
...
class _PackViewState extends State<PackView> {
  ...
  void _menuCallback(MenuType menuType, Map packData) {
    showBottomMenu(packData);
  }

  void showBottomMenu(Map packData) {
